...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Ejemplares',
            'route'=> 'ejemplares.index',
            'icon' => 'fa fa-paw',
            'active' => ['ejemplares', 'ejemplares/create', 'regex:@^ejemplares/[0-9]+$@', 'regex:@^ejemplares/[0-9]/edit+$@'],
        ],
        [
            'text' => 'Criadores',
            'route'=> 'criadores.index',
            'icon' => 'fa fa-industry',
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'active' => ['colores', 'colores/create', 'regex:@^colores/[0-9]+$@', 'regex:@^colores/[0-9]/edit+$@'],
                ],
                [
                    'text' => 'Direcciones',
