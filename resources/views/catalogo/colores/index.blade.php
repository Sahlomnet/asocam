            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($colors as $color)
                        <tr>
                            <!-- <td  class="text-center list-link"><a href="{{route('colores.show', $color->id)}}">{{ $color->id}}</a></td> -->
                            <td  class="text-center list-link"><a href="{{route('colores.show', $color->id)}}">{{ $color->code}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('colores.show', $color->id)}}">{{ $color->description}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('colores.show', $color->id)}}">{{ $color->notes}}</a></td> -->
                        </tr>
                    @endforeach
