                ...
                <tbody>
                    @foreach ($categories as $category)
                        <tr>
                            ...
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->code}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->description}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('categorias.show', $category->id)}}">{{ $category->notes}}</a></td> -->
                        </tr>
                    @endforeach
