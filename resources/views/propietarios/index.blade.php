            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($owners as $owner)
                        <tr>
                            <!-- <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->id}}</a></td> -->
                            <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->code}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->name}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->tel_01}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->tel_02}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->mail}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('propietarios.show', $owner->id)}}">{{ $owner->notes}}</a></td> -->
                        </tr>
                    @endforeach
