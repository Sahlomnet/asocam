            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                <thead class="bg-secondary text-white">
                    <tr>
                        ...
                        <th class="text-center">Teléfono1</th>
                        <th class="text-center">Teléfono2</th>
                ...
                <tbody>
                    @foreach ($breeders as $breeder)
                        <tr>
                            <!-- <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->id}}</a></td> -->
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->code}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->membership}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->name}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->tel_01}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->tel_02}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->mail}}</a></td>
                            <!-- <td  class="text-center list-link"><a href="{{route('criadores.show', $breeder->id)}}">{{ $breeder->notes}}</a></td> -->
                        </tr>
                    @endforeach
