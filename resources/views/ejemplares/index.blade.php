            ...
            <table id="table01" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%">
                ...
                <tbody>
                    @foreach ($specimens as $specimen)
                        <tr>
                            <!-- <td  class="text-center list-link"><a href="{{route('ejemplares.show', $specimen->id)}}">{{ $specimen->id}}</a></td> -->
                            ...
                            <!-- <td  class="text-center list-link"><a href="{{route('ejemplares.show', $specimen->id)}}">{{ $specimen->owner_id}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('ejemplares.show', $specimen->id)}}">{{ $specimen->father_code}}</a></td>
                            <td  class="text-center list-link"><a href="{{route('ejemplares.show', $specimen->id)}}">{{ $specimen->mother_code}}</a></td> -->
                            <!-- <td  class="text-center list-link"><a href="{{route('ejemplares.show', $specimen->id)}}">{{ $specimen->notes}}</a></td> -->
                        </tr>
                    @endforeach
